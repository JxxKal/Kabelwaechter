...
/// Wrapper über `NETunnelProviderManager` für die macOS-App (Phase 7 /
/// Milestone B). Funktional identisch zur iOS/tvOS-Variante — Provider ist die
/// macOS Network Extension (`KabelwaechterNEmac`). Verbindet nur Tunnel, die
/// diesem Mac gehören (Ownership-Gate liegt in der UI).
@MainActor
@Observable
final class TunnelManager {
    ...
    private let providerBundleIdentifier: String = KabelwaechterConstants.BundleIdentifiers.macNetworkExtension
