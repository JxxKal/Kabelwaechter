...
/// Mapping zwischen unserer Core-Domain (`KabelwaechterCore.TunnelConfiguration`)
/// und der WireGuardKit-Repräsentation, die der `WireGuardAdapter` erwartet.
///
/// Hintergrund: Core hat eigene Modelltypen, weil die iOS-App-Seite
/// WireGuardKit nicht linken darf (Go-Bridge nur tvOS, siehe ADR-0001 /
/// Plan §6). Die NE darf, also übersetzen wir hier.
